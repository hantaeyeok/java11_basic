...
public class CalcExam3 {
	...
	public static void main(String[] args) {
		...
		int num2 = 4;
		Repeator rep1;
		rep1 = new Arithmatic();				//Arithmatic이 자식클래스라 생성할 수 있다.
//		rep1 = new Calcurator();				//Repeator가 자식 클래스라 부모클래스를 생성할 수 없다.//자식클래스로 선언된 인스턴스(객체)는 부모 생성자로 생성할 수 없다.
//		rep1 = new Repeator();					//Repeator 클래스는 추상클래스이므로 내부에 추상 메소드가 존재하고 있어 구현 내용이 없으므로 생성할 수 없다.
