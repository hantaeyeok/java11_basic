...
//		map2.clear();
		...
		System.out.println("map2 에서 가장 첫 Entry : "+map2.firstEntry());
		System.out.println("map2 에서 가장 첫 키 : "+map2.firstKey());
		System.out.println("map2 에서 마지막 Entry : "+map2.lastEntry());
		System.out.println("map2 에서 마지막 Key : "+map2.lastKey());
